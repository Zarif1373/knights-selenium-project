...
public class PracticeValidateAccountsRowCount {
    // User  story # 7
    public static void main(String[] args) {
        ...
        if (tableRowsElement.size() == 10) {
            System.out.println("Test passed 10 rows shows in table");
        } else {
            System.out.println("Test failed number of rows not match to 10 actual is: " + tableRowsElement.size());
        }
        driver.quit();
    }
}

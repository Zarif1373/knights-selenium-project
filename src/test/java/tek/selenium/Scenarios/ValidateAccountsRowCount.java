...
public class ValidateAccountsRowCount {
    /*
    User Story 7: As Selenium Activity
As CSR User when login with valid user
When click on accounts link from left side panel
Validate table shows 10 records in first page.
     */
